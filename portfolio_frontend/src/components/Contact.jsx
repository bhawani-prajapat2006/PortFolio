...
export default function Contact() {
  return (
    <section id="contact">
      ...
      <h5 style={{color: "#9CA3AF"}} className="text-center">If you have any idea, suggestion or just wanna work with me. Feel free to reach out!</h5>
      <div className="contact-card">
        ...
        <div className="small2-card">
          <div className="small-2-card p-4 px-5 text-xl bg-blue-900/5">
            ...
            <div>
              <i style={{ color: "#00ffc3" }} class="fa-solid fa-envelope"></i>
              &nbsp;&nbsp;Email &nbsp;&nbsp;&nbsp;
              <a
                target="_blank"
